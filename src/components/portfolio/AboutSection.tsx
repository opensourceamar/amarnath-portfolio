...
const AboutSection = () => {
  return (
    <div className="w-full h-[calc(100vh-4rem)] flex items-center justify-center px-4 sm:px-8 lg:px-12 py-2 relative overflow-hidden bg-[#060709] text-slate-100 font-sans select-none">
      ...
      <div className="mx-auto max-w-6xl w-full grid grid-cols-1 lg:grid-cols-12 gap-6 lg:gap-10 items-center relative z-10">
        ...
        <div className="lg:col-span-6 xl:col-span-6 flex justify-center lg:justify-start items-center">
          <div className="w-full max-w-[420px] sm:max-w-[460px] lg:max-w-[490px]">
            <img
        ...
        <div className="lg:col-span-6 xl:col-span-6 flex flex-col justify-center space-y-4 text-left">

          {/* Section Eyebrow (Clean typography, no capsule) */}
          <div className="flex items-center gap-2.5 text-sm sm:text-base font-mono uppercase tracking-[0.22em] text-slate-300">
          ...
          {/* Name Header */}
          <div>
            <h1 className="text-3xl sm:text-4xl md:text-5xl lg:text-5xl font-black tracking-tight text-transparent bg-clip-text bg-gradient-to-r from-white via-slate-100 to-slate-400">
              ANKEM AMARNATH
            </h1>
          </div>
          ...
          <div className="space-y-3 pt-1">
            <p className="text-xs sm:text-sm md:text-base leading-relaxed text-slate-300 font-light max-w-2xl">
